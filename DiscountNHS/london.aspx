...
<head runat="server">
<title>Discounts - NHS - London Map</title>
  ...
  <% Response.WriteFile("includes/account.aspx"); %>
    ...
    <div id="map">
      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" 
        ...
        <param name="movie" value="LondonMap.swf" />
        <param name="quality" value="high" />
        <param name="wmode" value="transparent" />
        <embed src="LondonMap.swf" quality="high" allowfullscreen="true" wmode="transparent" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="640" height="400"></embed>
      </object>
      </div>
        <br />
        <br />

        <asp:DataList ID="DataList1" runat="server" DataKeyField="tubeID" 
            DataSourceID="SqlDataSource1" RepeatColumns="3" CellPadding="10">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" 
                    NavigateUrl='<%# Eval("tubeID", "station.aspx?TID={0}") %>' 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [tube] ORDER BY [tubeName]">
        </asp:SqlDataSource>
        <br />
